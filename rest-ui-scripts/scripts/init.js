...
module.exports = function(
  ...
  appPackage.scripts = {
    start: 'rest-ui-scripts start',
    build: 'rest-ui-scripts build',
    test: 'rest-ui-scripts test --env=jsdom',
    eject: 'rest-ui-scripts eject',
  };
  ...
  // which doesn't install react and react-dom along with rest-ui-scripts
